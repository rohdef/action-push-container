(function (_, kotlin_kotlin, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core, kotlin_it_krzeminski_snakeyaml_engine_kmp, kotlin_com_squareup_okio_okio) {
  ...
  protoOf(YamlException).toString = function () {
    return '' + getKClassFromExpression(this).q9() + ' at ' + this.w1q_1.d1r() + ' on line ' + this.z1q_1 + ', column ' + this.a1r_1 + ': ' + this.r8();
  };
  ...
  function NoAnchorForExtensionException(key, extensionDefinitionPrefix, path) {
    ...
    this.z1r_1 = key;
    this.a1s_1 = extensionDefinitionPrefix;
  }
  function UnknownAnchorException(anchorName, path) {
    ...
    this.h1s_1 = anchorName;
  }
  function YamlScalarFormatException(message, path, originalValue) {
    YamlException.call(this, message, path);
    captureStack(this, YamlScalarFormatException);
    this.o1s_1 = originalValue;
  }
  function DuplicateKeyException(originalPath, duplicatePath, key) {
    YamlException.call(this, 'Duplicate key ' + key + '. It was previously given at line ' + originalPath.c1r_1.r1o_1 + ', column ' + originalPath.c1r_1.s1o_1 + '.', duplicatePath);
    captureStack(this, DuplicateKeyException);
    this.v1s_1 = originalPath;
    this.w1s_1 = duplicatePath;
    this.x1s_1 = key;
    this.y1s_1 = this.v1s_1.c1r_1;
    this.z1s_1 = this.w1s_1.c1r_1;
  }
  ...
  protoOf(YamlNode).g1v = function () {
    return this.r1t().c1r_1;
  };
  protoOf(YamlNode).i1v = function (child, newParentPath) {
    return new YamlPath(plus(newParentPath.b1r_1, drop(child.r1t().b1r_1, this.r1t().b1r_1.k())));
  };
  ...
  function withSegment($this, segment) {
    return new YamlPath(plus_0($this.b1r_1, segment));
  }
  ...
  function YamlPath(segments) {
    ...
    var tmp;
    var tmp_0 = first(this.b1r_1);
    if (!(tmp_0 instanceof Root)) {
      var tmp_1 = first(this.b1r_1);
  ...
  protoOf(YamlPath).d1r = function () {
    var builder = StringBuilder_init_$Create$();
    var nextSegmentIndex = 1;
    while (nextSegmentIndex <= get_lastIndex(this.b1r_1)) {
      var segmentIndex = nextSegmentIndex;
      nextSegmentIndex = nextSegmentIndex + 1 | 0;
      var segment = this.b1r_1.p(segmentIndex);
        ...
        if (segment instanceof MapElementKey) {
          ...
          if (segment instanceof AliasReference) {
            ...
            if (segment instanceof Merge) {
              builder.n7('>>(merged');
              var tmp;
              if (nextSegmentIndex <= get_lastIndex(this.b1r_1)) {
                var tmp_0 = this.b1r_1.p(nextSegmentIndex);
              ...
              if (tmp) {
                builder.n7(' entry ');
                var tmp_1 = this.b1r_1.p(nextSegmentIndex);
                builder.db((tmp_1 instanceof ListEntry ? tmp_1 : THROW_CCE()).h1y_1);
                nextSegmentIndex = nextSegmentIndex + 1 | 0;
              }
              var tmp_2;
              if (nextSegmentIndex <= get_lastIndex(this.b1r_1)) {
                var tmp_3 = this.b1r_1.p(nextSegmentIndex);
              ...
              if (tmp_2) {
                builder.n7(' &');
                var tmp_4 = this.b1r_1.p(nextSegmentIndex);
  ...
  protoOf(YamlPath).toString = function () {
    return 'YamlPath(segments=' + toString(this.b1r_1) + ')';
  };
